...
class TestDropboxTokenManager(unittest.TestCase):
    ...
    @patch.object(
        DropboxTokenManager, "authentication", return_value="new_access_token"
    )
    ...
    def test_authentication(
        self, mock_handle_callback, mock_start_server, mock_webbrowser, mock_post
    ):
    ...
    @patch.object(
        DropboxTokenManager, "get_access_token", return_value="fake_access_token"
    )
